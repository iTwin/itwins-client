...
export interface Repository {
  ...
  id: string;
  /** Main classification identifier returned by the API */
  class: RepositoryClass;
  /** Optional subclass identifier returned by the API for more specific categorization */
 ...
 * @beta
 */
export type RepositoryClass = string;

/**
 * Repository subclass identifier returned by the API.
 * Known values include WebMapService, WebMapTileService,
 * WebFeatureService, ArcGIS, UrlTemplate, OgcApiFeatures,
 * EvoWorkspace, and Performance.
 * @beta
 */
export type RepositorySubClass = string;
 ...
 * Contains the created resource with minimal information including ID,
 * class, subClass, and displayName.
 * @beta
 */
 ...
 * Extends the base Repository interface while omitting properties that are generated by the API.
 * Repository class and subClass values are modeled as API-provided string identifiers.
 * @beta
 */
...
export interface Google2DImageryProviderOptions {
  ...
  url?: string;
  /** The session token returned by the provider API. */
  session?: string;
